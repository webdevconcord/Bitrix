...
include __DIR__ . '/concordpay.php';
...
$description = GetMessage('CONCORDPAY_DESCRIPTION') . ' ' . $currentSite . ', ' .
...
$callbackUrl = empty(CSalePaySystemAction::GetParamValue('CP_SERVER_CALLBACK_URL')) ?
    $requestScheme . '://' . $currentSite . '/bitrix/tools/concordpay_payment/concordpay_result.php' :
